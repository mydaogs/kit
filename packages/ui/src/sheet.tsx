    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "left" &&
            "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left top-0 left-0 h-dvh w-3/4 border-r sm:max-w-sm",
          side === "top" &&
      ...
      >
        ...
        <SheetPrimitive.Close
          className={cn(
            "absolute top-4 text-foreground [&_svg]:size-8",
            side === "right" && "-left-12",
            side === "left" && "-right-12",
            side === "top" && "right-4",
            side === "bottom" && "right-4",
